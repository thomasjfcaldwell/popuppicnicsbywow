export const faqData = [
	{
		id: '1',
		question: 'Q: WHAT IS YOUR CANCELLATION POLICY?',
		answer:
	...
	},
	{
		id: '2',
		question:
			'Q: ARE THERE ANY OTHER ADDITIONAL FEES ADDED TO THE ITEMS and SERVICES I ORDER?',
		answer:
	...
	},
	{
		id: '3',
		question:
			'Q: WHAT HAPPENS IF I DAMAGE, REMOVE OR LOSE AN ITEM PROVIDED BY POP-UP PICNICS BY WOW! EVENTS?',
		answer:
	...
	{
		id: '4',
		question: 'Q: CAN WE HOLD OR DEPOSIT A PICNIC DATE?',
		answer:
	...
	{
		id: '5',
		question: 'Q: IS THERE A MINIMUM ORDER REQUIRED FOR A POP-UP PICNIC?',
		answer:
			'A: We do require a minimum order of $600 for Saturday and Sunday Picnics in June- September.',
	},
	{
		id: '6',
	...
	{
		id: '7',
		question: 'Q: WHAT IS INCLUDED IN THE POP-UP PICNICS PACKAGE?',
		answer:
	...
	{
		id: '10',
		question: 'Q: DOES THE POP-UP PICNICS HOST STAY DURING OUR PICNIC?',
		answer:
	...
	{
		id: '11',
		question: 'Q: CAN WE LEAVE WHENEVER WE WANT DURING OUR PICNIC?',
		answer:
	...
	},
	{
		id: '12',
		question:
			'Q: WHAT HAPPENS IF ONE OR MORE OF MY PAID GUESTS CANNOT MAKE MY BOOKING ON THE DAY OF OUR POP-UP PICNIC?',
		answer:
	...
	{
		id: '13',
		question: 'Q: SHOULD I INCLUDE MY KIDS IN THE GUEST COUNT WHEN BOOKING?',
		answer:
	...
	{
		id: '14',
		question: 'Q: DO I NEED A PERMIT FOR MY PICNIC?',
		answer:
			'A: That depends on the location, number of guests and a few other factors. POP-UP Picnics Packages offered include any required permits. If you request a special picnic site, not offered on our website, we will let you know if you will need a permit and can help you with the process.',
	},
	{
		id: '15',
		question: 'Q: WHAT ARE THE FOOD AND BEVERAGE OPTIONS?',
		answer:
	...
	},
	{
		id: '16',
		question:
			'Q: DO YOU OFFER VEGAN, VEGETARIAN OR GLUTEN FREE, DAIRY FREE, LOW SUGAR OPTIONS?',
		answer: 'A: YES! Our food options include something for everyone.',
	},
	{
		id: '17',
		question: 'Q: WHAT ABOUT BAD WEATHER?',
		answer:
